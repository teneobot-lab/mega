...
export default function APAging() {
  ...
  const handleExportExcel = () => {
    exportToExcel(filteredData, "Aging_Hutang", "Aging AP");
  };

  const handleExportPDF = () => {
    const columns = ["No. Invoice", "Supplier", "Tgl", "Jatuh Tempo", "Saldo", "Hari", "Kategori"];
    ...
    exportToPDF(columns, body, "Laporan Analisis Umur Hutang (Aging AP)", "Aging_AP");
  };
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold tracking-tight">Umur Hutang (Aging AP)</h1>
        </div>
      ...
      <div className="bg-white p-4 border rounded shadow-sm">
        <div className="flex items-center bg-zinc-100 px-3 rounded-md mb-4 max-w-sm">
          ...
          <Input 
            placeholder="Cari supplier atau no. inv..." 
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow><TableCell colSpan={7} className="text-center py-10 text-zinc-500 italic">Tidak ada hutang jatuh tempo</TableCell></TableRow>
