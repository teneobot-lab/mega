    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
            <h1 className="text-2xl font-black tracking-tighter text-[#1e3a5f] uppercase italic">Daftar Pajak</h1>
            <p className="text-xs text-zinc-500 font-medium">Data Master Pajak</p>
        </div>
        <Button 
            onClick={() => navigate("/master/taxes/new")}
            ...
            {loading ? (
               ...
               <TableRow>
                 <TableCell colSpan={4} className="text-center py-20">
                     <div className="flex flex-col items-center gap-2 opacity-20">
                         ...
                         <p className="text-sm font-bold uppercase tracking-widest">Belum ada data Pajak</p>
                     </div>
                 </TableCell>
               </TableRow>
            ) : (
              data.map((t) => (
                <TableRow 
                    ...
                    onClick={() => navigate(`/master/taxes/${t.id}`)}
                >
                  <TableCell className="font-bold text-[#1e3a5f] pl-6 group-hover:underline">{t.code}</TableCell>
                  <TableCell className="text-sm font-semibold text-zinc-700">{t.name}</TableCell>
